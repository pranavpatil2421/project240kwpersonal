// --- Place Header and Footer functions here or load via separate JS files ---
...
function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden flex flex-col">
      <Header />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="group relative p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
                  ...
                  {feature.title === 'Advanced Testing' && (
                    <div className="mt-6">
                      <a href="/testing-info">
                        <button className="px-5 py-2.5 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-all text-sm">
